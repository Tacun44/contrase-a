...
export default function PasswordManagerPage() {
  ...
  const handleAddPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewPassword({ servicio: "", usuario: "", contraseña: "", notas: "" });
              ...
              <div className="modal-content">
                ...
                <form onSubmit={handleAddPassword} className="add-form">
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      value={newPassword.notas}
                      onChange={(e) => setNewPassword({...newPassword, notas: e.target.value})}
                  ...
                  <div key={password.id} className="password-card">
                    ...
                    <div className="password-details">
                      ...
                      {password.notas && (
                        <div className="password-field">
                          <label>Notas</label>
                          <div className="notes-value">{password.notas}</div>
                        </div>
                      )}
